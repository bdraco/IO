...
sub connect {
    @_ == 2 || @_ == 3 or
       Carp::croak 'usage: $sock->connect(NAME) or $sock->connect(PORT, ADDR)';
    my $sock = shift;
...
sub bind {
    @_ == 2 || @_ == 3 or
       Carp::croak 'usage: $sock->bind(NAME) or $sock->bind(PORT, ADDR)';
    my $sock = shift;
    return $sock->SUPER::bind(@_ == 1 ? shift : Socket::pack_sockaddr_in(@_))
}

sub sockaddr {
    @_ == 1 or Carp::croak 'usage: $sock->sockaddr()';
    my($sock) = @_;
...
sub sockport {
    @_ == 1 or Carp::croak 'usage: $sock->sockport()';
    my($sock) = @_;
    my $name = $sock->sockname;
...
sub sockhost {
    @_ == 1 or Carp::croak 'usage: $sock->sockhost()';
    my($sock) = @_;
...
sub peeraddr {
    @_ == 1 or Carp::croak 'usage: $sock->peeraddr()';
    my($sock) = @_;
...
sub peerport {
    @_ == 1 or Carp::croak 'usage: $sock->peerport()';
    my($sock) = @_;
    my $name = $sock->peername;
    $name ? (Socket::sockaddr_in($name))[0] : undef;
}
...
sub peerhost {
    @_ == 1 or Carp::croak 'usage: $sock->peerhost()';
    my($sock) = @_;
